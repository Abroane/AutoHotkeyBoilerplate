/*
Pulled in its entirety from https://autohotkey.com/board/topic/1257-half-qwerty-one-handed-typing/
first post by a person named Jonny

The purpose of this script is to allow full typing with only your right hand by on keypress mirroring the right side
of the keyboard onto the left.

This is not currently implemented in anyway.  just saved here for future testing and possible inclusion
