; =================================================================================================================================
; Name:           Ishido
; Description:    A ishido clone in AHK
; Topic:          https://www.autohotkey.com/boards/viewtopic.php?t=31825https://github.com/flibioahk/ishido
; Sript version:  unknown
; AHK Version:    unknown  
; Author::        maestrith
	...
	Init()
	{
		...
		Loop, 6
		{
			...
			Loop, 6
			{
				...
				if (A_Index = val) ; si �s la que ha sortit per random la guardem per retornar-la a les inicials
					tIniStones.Push(st)
				else
					this.Stones.Push(st)
			}
		}
		this.Stones.InsertAt(1,tIniStones*) ;insertem moment�niament les que queden fora al principi de l'array per duplicar m�s f�cilment les que hi ha
		this.Stones.InsertAt((this.Stones.Length() + 1), this.Stones*) ;aix� es dupliquen totes
