; All credits go to user Uberi.
; Original topic: https://autohotkey.com/board/topic/64530-platformer-demo-opengl/
...
LoadTexture(Filename)
{
 ...
 DllCall("opengl32\glTexParameteri","UInt",0xDE1,"UInt",0x2801,"Int",0x2601) ;GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, GL_LINEAR. Set the minifying filter
 DllCall("opengl32\glTexParameteri","UInt",0xDE1,"UInt",0x2800,"Int",0x2601) ;GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_LINEAR. Set the magnification filter
